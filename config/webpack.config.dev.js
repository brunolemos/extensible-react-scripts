...
module.exports = {
  ...
  resolve: {
    ...
    plugins: [
      ...
      new ModuleScopePlugin(paths.sourcesToCompile, [paths.appPackageJson]),
    ],
  },
  module: {
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          {
            test: /\.(js|jsx|mjs)$/,
            include: paths.sourcesToCompile,
...
module.exports = (webpackConfig => {
  ...
  return extender(webpackConfig, { isDevelopment: true, paths, resolveApp })
})(module.exports)
